...
var file_room_rcommon_proto_goTypes = []any{
...
func file_room_rcommon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_room_rcommon_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Vector); i {
			case 0:
				return &v.state
			case 1:
		...
		file_room_rcommon_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_room_rcommon_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Skill); i {
			case 0:
				return &v.state
			case 1:
		...
		file_room_rcommon_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Buff); i {
			case 0:
				return &v.state
			case 1:
		...
		file_room_rcommon_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_room_rcommon_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Range); i {
			case 0:
				return &v.state
			case 1:
		...
		file_room_rcommon_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Item); i {
			case 0:
				return &v.state
			case 1:
		...
		file_room_rcommon_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Items); i {
			case 0:
				return &v.state
			case 1:
		...
		file_room_rcommon_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_room_rcommon_proto_msgTypes[9].Exporter = func(v any, i int) any {
