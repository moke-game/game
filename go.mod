...
require (
	...
	github.com/moke-game/platform v0.0.0-20260811134025-05b9ca55ed6a
...
require (
	agones.dev/agones v1.48.0 // indirect
	github.com/ClickHouse/ch-go v0.65.1 // indirect
	github.com/ClickHouse/clickhouse-go/v2 v2.34.0 // indirect
	github.com/ThinkingDataAnalytics/go-sdk/v2 v2.2.0 // indirect
