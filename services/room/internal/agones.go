...
// Battle房间使用Agones High Density GameServers 集成模式
//Deprecated: https://agones.dev/site/docs/integration-patterns/high-density-gameservers/
// Refactor: https://github.com/googleforgames/agones/issues/2716
